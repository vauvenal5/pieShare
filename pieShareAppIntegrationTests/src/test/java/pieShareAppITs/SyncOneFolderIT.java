...
public class SyncOneFolderIT {
	...
	public void tearDownMethod() throws Exception {
        ...
        /**
         * Main and Bot are two instances which simulate two devices,
         * they are connected and should sync files and folders.
         * A folder created in the working directory of the Bot
         * should trigger a FolderCreateMessage and Sync with Main
         * Main should create the same folder in the working directory.
         * @throws Exception 
         */
	@Test(timeOut = 120000)
